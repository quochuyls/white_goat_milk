...
<div class="row">
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Chỉnh sửa thông tin sự kiện nông trại!</h2>
				...
				{!! Form::open([
					...
					<div id="wizard" class="form_wizard wizard_horizontal">
	                    ...
	                    <div id="step-1">
								...
								<div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="content_vi">Nội dung</label>
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        {!! Form::textarea(
                                            'content_vi',
                                            $event['content_vi'],
	                    ...
	                    <div id="step-3">
	                        <div class="form-group">
                                ...
                                <div class="col-xs-7">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="link-flick">Link Flick</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            {!! Form::text(
                                            'link_flick',
                                            $event['link_flick'],
