                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home">
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        @if ($event['thumbnail'] != '')
                                            <img src="{{ URL::asset('/images/event-customer/' . $event['thumbnail']) }}"
                                    ...
                                    <div class="col-xs-9">
                                        ...
                                        <br />
                                        <div class="row">
                                            <div class="col-xs-2 text-right"><label>Thời gian sự kiện:</label></div>
                                            <div class="col-xs-10">Tháng: {{ $event['month'] }} / Năm : {{ $event['year'] }}</div>
                                        </div>
                                        <br />
                                        <div class="row">
                            ...
                            <div class="tab-pane" id="profile">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        ...
                                        <br />
                                        <div class="row">
                                            <div class="col-xs-2 text-right"><label>Time:</label></div>
                                            <div class="col-xs-10">Tháng: {{ $event['month'] }} / Năm : {{ $event['year'] }}</div>
                                        </div>
                                        <br />
                                        <div class="row">
