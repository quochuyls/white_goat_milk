...
<div class="content-top">
	...
	<a  class="link noidung2" href="javascript: void(0);"><img class="img img2 big"src="{{ URL::asset('/images/Farm.png') }}"/></a>
...
<script type="text/javascript" src="{{ URL::asset('/js/dulichthucnghiem.js') }}"></script>
@stop
