...
<div class="content-top">
	<a class="link noidung1 " href="javascript: void(0);"><img class="img img1 big" src="{{ URL::asset('/images/boy-bsn.png') }}"/></a>
	...
	<a class="link noidung3" href="javascript: void(0);"><img class="img img3 small" src="{{ URL::asset('/images/milk.png') }}"/></a>
...
<script type="text/javascript" src="{{ URL::asset('/js/nongtraigiaoduc.js') }}"></script>
@stop
