...
<body>
	...
	<br />
	<br />
	<a href="{{ route('order.confirm', ['id' => $orderId, 'token' => $token]) }}" style="background: #426d8b; color:
	#fff; font-size: 16px; font-weight: bold; float: right; margin-right: 50px; padding: 9px; border-radius: 5px;">
